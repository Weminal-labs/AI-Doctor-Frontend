...
export default function Snackbar(props: CustomizedModalItemProps) {
  ...
  switch (data.headerColor) {
    case "info": {
      title = (
        <span className="material-symbols-outlined text-on-info">help</span>
      );
      break;
    }
    case "success": {
      title = (
        <span className="material-symbols-outlined text-on-success">done</span>
      );
      break;
    }
    case "warning": {
      title = (
        <span className="material-symbols-outlined text-on-warning">
          warning
        </span>
      );
      break;
